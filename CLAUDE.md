...
**PENDING DECISION: `email_send_log` retention.** It stores full addresses indefinitely, including for people who unsubscribed, which the privacy policy does not describe. A proposal is with Malcolm; the table is unchanged until it is ruled on.
